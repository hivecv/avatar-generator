...
if [ ! -d "/data/config/auto/extensions/sd-webui-reactor" ]; then
  git clone https://hive:gldt-pyYGqP3Gshp3suLNbaqk@gitlab.com/hivecv/11bit/sd-webui-reactor.git /data/config/auto/extensions/sd-webui-reactor
fi
